...
{
  private:
    Eigen::MatrixXd MapValues(const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_LocalSpace_Data &local_space,
                              const Eigen::MatrixXd &referenceValues) const;

    std::vector<Eigen::MatrixXd> MapDerivativeValues(const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_LocalSpace_Data &local_space,
    ...
    Gedim::Quadrature::QuadratureData InternalQuadrature(const Gedim::Quadrature::QuadratureData &reference_quadrature,
                                                         const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_LocalSpace_Data &local_space) const;

    std::array<Gedim::Quadrature::QuadratureData, 6> BoundaryQuadrature(
        const std::array<Polydim::FEM::PCC::FEM_Quadrilateral_PCC_2D_LocalSpace_Data, 6> &faces_local_space_data,
        const Polydim::FEM::PCC::FEM_PCC_3D_Polyhedron_Geometry &polyhedron) const;

  public:
    Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_LocalSpace_Data CreateLocalSpace(
        const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_ReferenceElement_Data &reference_element_data,
        const Polydim::FEM::PCC::FEM_PCC_3D_Polyhedron_Geometry &polyhedron) const;

    inline Eigen::MatrixXd ComputeBasisFunctionsValues(const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_ReferenceElement_Data &reference_element_data,
                                                       const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_LocalSpace_Data &local_space) const
    {
                                                       ...
                                                       const Eigen::MatrixXd &points) const
    {
        ...
        Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_ReferenceElement reference_element;
    ...
    inline Eigen::MatrixXd EdgeDOFsCoordinates(const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_ReferenceElement_Data &reference_element_data,
                                               const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_LocalSpace_Data &local_space,
    ...
    inline Eigen::MatrixXd FaceDOFsCoordinates(const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_ReferenceElement_Data &reference_element_data,
                                               const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_LocalSpace_Data &local_space,
    ...
    inline Eigen::MatrixXd ComputeBasisFunctionsValuesOnEdge(const Polydim::FEM::PCC::FEM_Hexahedron_PCC_3D_ReferenceElement_Data &reference_element_data,
