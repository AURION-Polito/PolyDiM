...
class FEM_MCC_2D_LocalSpace final
{
  ...
  public:
                                      ...
                                      const Eigen::MatrixXd &referenceValues) const
    {
        ...
        {
        case Polydim::FEM::MCC::FEM_MCC_2D_Types::RT_Triangle: {
            return rt_triangle_local_space.MapPressureValues(local_space.rt_triangle_local_space_data, referenceValues);
        }
        default:
            throw std::runtime_error("not valid fem type");
        }
    ...
    Eigen::MatrixXd MapVelocityDivergenceValues(const Polydim::FEM::MCC::FEM_MCC_2D_LocalSpace_Data &local_space,
                                                const Eigen::MatrixXd &referenceDerivateValues) const
    {
        switch (local_space.fem_type)
        {
        case Polydim::FEM::MCC::FEM_MCC_2D_Types::RT_Triangle: {
            return rt_triangle_local_space.MapVelocityDivergenceValues(local_space.rt_triangle_local_space_data, referenceDerivateValues);
        }
        default:
            throw std::runtime_error("not valid fem type");
        }
    ...
    Gedim::Quadrature::QuadratureData InternalQuadrature(const Gedim::Quadrature::QuadratureData &reference_quadrature,
                                                         const FEM_MCC_2D_LocalSpace_Data &local_space) const
    {
        switch (local_space.fem_type)
        {
        case Polydim::FEM::MCC::FEM_MCC_2D_Types::RT_Triangle: {
            return rt_triangle_local_space.InternalQuadrature(reference_quadrature, local_space.rt_triangle_local_space_data);
        }
        default:
            throw std::runtime_error("not valid fem type");
        }
    ...
    std::vector<Gedim::Quadrature::QuadratureData> BoundaryQuadrature(const FEM_MCC_2D_LocalSpace_Data &local_space,
                                                                      ...
                                                                      const Polydim::FEM::MCC::FEM_MCC_2D_Polygon_Geometry &polygon) const
    {
        ...
        {
        case Polydim::FEM::MCC::FEM_MCC_2D_Types::RT_Triangle: {
            return rt_triangle_local_space.BoundaryQuadrature(reference_quadrature, polygon);
        }
        default:
            throw std::runtime_error("not valid fem type");
        }
