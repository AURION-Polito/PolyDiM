                                         ...
                                         const std::function<double(const double &, const double &, const double &)> exact_solution_function)
{
    ...
    for (unsigned int c = 0; c < mesh.Cell2DTotalNumber(); c++)
    {
        ...
        // test.exact_derivative_solution(cell2D_internal_quadrature.Points, time_value);
        ...
        //     exact_derivative_solution_values[0]).array().square() + (basis_functions_derivative_values[1] *
        //     dofs_values - exact_derivative_solution_values[1]).array().square();
