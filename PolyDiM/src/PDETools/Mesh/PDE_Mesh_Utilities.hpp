                                   ...
                                   Gedim::MeshMatricesDAO &mesh)
        {
          switch (mesh_type)
          {
            case MeshGenerator_Types_3D::Tetrahedral: {
              ...
              mesh_utilities.CreateTetrahedralMesh(pde_domain.vertices,
                                                   pde_domain.edges,
                                                   pde_domain.faces,
                                                   max_cell_volume,
                                                   mesh);
            ...
            case MeshGenerator_Types_3D::Minimal: {
              mesh_utilities.Mesh3DFromPolyhedron(pde_domain.vertices,
                                                  pde_domain.edges,
                                                  pde_domain.faces,
                                                  {},
                                                  {},
                                   ...
                                   Gedim::MeshMatricesDAO &mesh)
        {
          switch (mesh_type)
          {
            case MeshGenerator_Types_3D::OVMImporter:
            {
              ...
              mesh_utilities.ImportOpenVolumeMesh(file_path,
                                                  mesh,
            ...
            {
              mesh_utilities.ImportVtkMesh3D(file_path,
                                             mesh);
            }
            default:
              throw std::runtime_error("MeshGenerator_Types_3D " + std::to_string((unsigned int)mesh_type) +
