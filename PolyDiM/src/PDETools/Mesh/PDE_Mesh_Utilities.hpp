...
struct PDE_Mesh_Utilities
{
    ...
    static inline void create_mesh_2D(const Gedim::GeometryUtilities &geometry_utilities,
                                      const Gedim::MeshUtilities &mesh_utilities,
    ...
    static inline void create_mesh_3D(const Gedim::GeometryUtilities &geometry_utilities,
                                      const Gedim::MeshUtilities &mesh_utilities,
                                      ...
                                      Gedim::MeshMatricesDAO &mesh)
    {
        ...
        case Polydim::PDETools::Mesh::PDE_Mesh_Utilities::MeshGenerator_Types_3D::Cubic: {
            ...
            mesh_utilities.CreateParallelepipedMesh(
                domain_origin,
                domain_base_tangent,
    ...
    static inline void import_mesh_1D(const Gedim::GeometryUtilities &geometry_utilities,
                                      const Gedim::MeshUtilities &mesh_utilities,
                                      const Polydim::PDETools::Mesh::PDE_Mesh_Utilities::MeshGenerator_Types_1D &mesh_type,
    ...
    static inline void import_mesh_2D(const Gedim::GeometryUtilities &geometry_utilities,
                                      const Gedim::MeshUtilities &mesh_utilities,
                                      const Polydim::PDETools::Mesh::PDE_Mesh_Utilities::MeshGenerator_Types_2D &mesh_type,
                                      const std::string &file_path,
                                      Gedim::MeshMatricesDAO &mesh)
    ...
    static inline void import_mesh_3D(const Gedim::GeometryUtilities &geometry_utilities,
                                      const Gedim::MeshUtilities &mesh_utilities,
                                      const Polydim::PDETools::Mesh::PDE_Mesh_Utilities::MeshGenerator_Types_3D &mesh_type,
                                      const std::string &file_path,
                                      Gedim::MeshMatricesDAO &mesh)
