...
{
//***************************************************************************
void DOFsManager::ConcatenateGlobalDOFs(const unsigned int local_cell_dimension,
                                        const unsigned int local_cell_index,
                                        const std::vector<DOFsData::DOF> &local_cell_DOFs,
                                        std::vector<DOFsData::GlobalCell_DOF> &global_cell_DOFs,
