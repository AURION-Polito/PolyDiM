...
#define __VEM_DF_PCC_2D_Reduced_Pressure_LocalSpace_HPP
...
class VEM_DF_PCC_2D_Reduced_Pressure_LocalSpace final : public Polydim::VEM::DF_PCC::I_VEM_DF_PCC_2D_Pressure_LocalSpace
{
  private:
  ...
  public:
    virtual ~VEM_DF_PCC_2D_Reduced_Pressure_LocalSpace()
    {
    }

    Polydim::VEM::DF_PCC::VEM_DF_PCC_2D_Pressure_LocalSpace_Data CreateLocalSpace(
        const Polydim::VEM::DF_PCC::VEM_DF_PCC_2D_Pressure_ReferenceElement_Data &reference_element_data,
