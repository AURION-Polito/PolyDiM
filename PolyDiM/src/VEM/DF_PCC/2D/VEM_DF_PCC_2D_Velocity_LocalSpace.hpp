...
class VEM_DF_PCC_2D_Velocity_LocalSpace final
{
private:
...
public:
    ...
    /// \param localSpace: an object of type \ref VEM::PCC::VEM_DF_PCC_2D_Velocity_LocalSpace_Data which contains local matrices.
    ...
    /// \param reference_element_data: an object of type \ref VEM::PCC::VEM_DF_PCC_2D_Velocity_ReferenceElement_Data which contains monomials stuff.
    /// \param polygon: an object of type \ref VEM::PCC::VEM_DF_PCC_2D_Polygon_Geometry which contains the geoemtric properties of the elements.
    /// \param localSpace: an object of type \ref VEM::PCC::VEM_DF_PCC_2D_Velocity_LocalSpace_Data which contains local matrices.
    /// \param projectionType: the \ref VEM::PCC::ProjectionTypes reporting the kind of projector used to access to the point-wise evalution of VE basis functions.
