...
#ifndef __I_VEM_DF_PCC_2D_Pressure_LocalSpace_HPP
#define __I_VEM_DF_PCC_2D_Pressure_LocalSpace_HPP
...
/// Divergence-Free Primal Conforming Constant degree Virtual Element Methods \cite DaVeigaLovadina2017.
class I_VEM_DF_PCC_2D_Pressure_LocalSpace
{
  public:
    /// \brief Class destructor.
    virtual ~I_VEM_DF_PCC_2D_Pressure_LocalSpace()
    {
    }
    ...
    virtual VEM_DF_PCC_2D_Pressure_LocalSpace_Data CreateLocalSpace(const VEM_DF_PCC_2D_Pressure_ReferenceElement_Data &reference_element_data,
    ...
    virtual Eigen::MatrixXd ComputeBasisFunctionsValues(const VEM_DF_PCC_2D_Pressure_LocalSpace_Data &localSpace) const = 0;
    ...
    /// \return A matrix containing the values of a basis function on each column.
    virtual Eigen::MatrixXd ComputeBasisFunctionsValues(const VEM_DF_PCC_2D_Pressure_ReferenceElement_Data &reference_element_data,
    ...
    /// \param localSpace Data of the local space.
    /// \return A matrix containing the values of a basis function on each column.
    virtual Eigen::MatrixXd ComputePolynomialsValues(const VEM_DF_PCC_2D_Pressure_LocalSpace_Data &localSpace) const = 0;
    ...
    /// \param points Evaluation points.
    /// \return A matrix containing the values of a basis function on each column.
    virtual Eigen::MatrixXd ComputePolynomialsValues(const VEM_DF_PCC_2D_Pressure_ReferenceElement_Data &reference_element_data,
                                                     const VEM_DF_PCC_2D_Pressure_LocalSpace_Data &localSpace,
                                                     const Eigen::MatrixXd &points) const = 0;
};
} // namespace DF_PCC
