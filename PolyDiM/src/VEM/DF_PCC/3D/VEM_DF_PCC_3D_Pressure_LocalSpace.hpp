...
class VEM_DF_PCC_3D_Pressure_LocalSpace final : public I_VEM_DF_PCC_3D_Pressure_LocalSpace
{
  ...
  public:
    VEM_DF_PCC_3D_Pressure_LocalSpace_Data CreateLocalSpace(const VEM_DF_PCC_3D_Pressure_ReferenceElement_Data &reference_element_data,
                                                            const VEM_DF_PCC_3D_Polyhedron_Geometry &polygon) const;
