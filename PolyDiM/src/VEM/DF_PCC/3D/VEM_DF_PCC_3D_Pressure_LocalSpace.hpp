...
#define __VEM_DF_PCC_3D_Pressure_LocalSpace_HPP
...
class VEM_DF_PCC_3D_Pressure_LocalSpace final : public I_VEM_DF_PCC_3D_Pressure_LocalSpace
{
  private:
    Polydim::VEM::DF_PCC::VEM_DF_PCC_Utilities<3> utilities;
    Polydim::Utilities::Monomials_3D monomials;

    void InitializeProjectorsComputation(const Polydim::VEM::DF_PCC::VEM_DF_PCC_3D_Pressure_ReferenceElement_Data &reference_element_data,
  ...
  public:
    Polydim::VEM::DF_PCC::VEM_DF_PCC_3D_Pressure_LocalSpace_Data CreateLocalSpace(
        const Polydim::VEM::DF_PCC::VEM_DF_PCC_3D_Pressure_ReferenceElement_Data &reference_element_data,
