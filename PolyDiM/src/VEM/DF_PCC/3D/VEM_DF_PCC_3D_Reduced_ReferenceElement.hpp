...
class VEM_DF_PCC_3D_Reduced_Pressure_ReferenceElement final : public Polydim::VEM::DF_PCC::I_VEM_DF_PCC_3D_Pressure_ReferenceElement
{
  public:
...
class VEM_DF_PCC_3D_Reduced_Velocity_ReferenceElement final : public Polydim::VEM::DF_PCC::I_VEM_DF_PCC_3D_Velocity_ReferenceElement
{
  public:
