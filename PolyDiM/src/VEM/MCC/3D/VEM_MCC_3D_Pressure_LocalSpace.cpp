...
{
//****************************************************************************
VEM_MCC_3D_Pressure_LocalSpace_Data VEM_MCC_3D_Pressure_LocalSpace::CreateLocalSpace(
    const VEM_MCC_3D_Pressure_ReferenceElement_Data &reference_element_data_3D,
    const VEM_MCC_3D_Polyhedron_Geometry &polyhedron) const
{
    ...
    VEM_MCC_3D_Pressure_LocalSpace_Data localSpace;
...
//****************************************************************************
void VEM_MCC_3D_Pressure_LocalSpace::InitializeProjectorsComputation(const VEM_MCC_3D_Pressure_ReferenceElement_Data &reference_element_data,
