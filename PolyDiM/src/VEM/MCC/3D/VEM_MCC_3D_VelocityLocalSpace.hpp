#ifndef __VEM_MCC_3D_VelocityLocalSpace_HPP
#define __VEM_MCC_3D_VelocityLocalSpace_HPP
...
class VEM_MCC_3D_VelocityLocalSpace final
{
private:
    ...
    void ComputeValuesOnBoundary(const VEM_MCC_3D_Velocity_ReferenceElement_Data& reference_element_data,
                                 ...
                                 VEM_MCC_VelocityLocalSpace_Data& localSpace) const;
public:
    VEM_MCC_VelocityLocalSpace_Data CreateLocalSpace(const VEM_MCC_3D_Velocity_ReferenceElement_Data& reference_element_data,
    ...
    {
        return monomials3D.Vander(reference_element_data.MonomialsKp1,
                                points,
                                polyhedron.Centroid,
                                polyhedron.Diameter).leftCols(localSpace.Nk);
    }
