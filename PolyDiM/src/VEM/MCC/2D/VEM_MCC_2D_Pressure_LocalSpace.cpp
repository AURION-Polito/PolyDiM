...
{
//****************************************************************************
VEM_MCC_2D_Pressure_LocalSpace_Data VEM_MCC_2D_Pressure_LocalSpace::CreateLocalSpace(const VEM_MCC_2D_Pressure_ReferenceElement_Data &reference_element_data,
                                                                                     const VEM_MCC_2D_Polygon_Geometry &polygon) const
{
    VEM_MCC_2D_Pressure_LocalSpace_Data localSpace;
...
//****************************************************************************
void VEM_MCC_2D_Pressure_LocalSpace::InitializeProjectorsComputation(const VEM_MCC_2D_Pressure_ReferenceElement_Data &reference_element_data,
