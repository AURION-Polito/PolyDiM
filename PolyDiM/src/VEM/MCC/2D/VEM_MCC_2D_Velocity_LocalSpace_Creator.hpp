#ifndef __VEM_MCC_2D_Velocity_LocalSpace_Creator_HPP
#define __VEM_MCC_2D_Velocity_LocalSpace_Creator_HPP
...
inline std::unique_ptr<I_VEM_MCC_2D_Velocity_LocalSpace> create_VEM_MCC_2D_local_space(const VEM_MCC_2D_LocalSpace_Types &type)
{
    switch (type)
    {
