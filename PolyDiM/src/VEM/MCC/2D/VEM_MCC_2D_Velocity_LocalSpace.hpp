        ...
        const Eigen::MatrixXd &points) const
    {
        ...
        case Polydim::VEM::MCC::ProjectionTypes::Pi0k: {
            ...
            const Eigen::MatrixXd VanderInternalKp1 =
                monomials.Vander(reference_element_data.MonomialsKp1, points, localSpace.Centroid, localSpace.Diameter);
            ...
            VanderInternal2k << VanderInternal.transpose(),
                ...
                Eigen::MatrixXd::Zero(VanderInternal.cols(), VanderInternal.rows()), VanderInternal.transpose();
            ...
            Eigen::MatrixXd GkVanderInternal =
                Eigen::MatrixXd::Zero(localSpace.Dimension * localSpace.Nk, localSpace.Dimension * numQuadrature);
            ...
            std::vector<Eigen::MatrixXd> result(localSpace.Dimension,
                                                Eigen::MatrixXd::Zero(localSpace.Dimension, localSpace.Pi0k.cols()));
