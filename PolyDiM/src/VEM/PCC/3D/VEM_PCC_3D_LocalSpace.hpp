...
class VEM_PCC_3D_LocalSpace final : public Polydim::VEM::PCC::I_VEM_PCC_3D_LocalSpace
{
  ...
  public:
    ...
    inline Eigen::MatrixXd ComputeBasisFunctionsLaplacianValues(const Polydim::VEM::PCC::VEM_PCC_3D_ReferenceElement_Data &reference_element_data,
                                                                const Polydim::VEM::PCC::VEM_PCC_3D_LocalSpace_Data &localSpace,
                                                                const Polydim::VEM::PCC::ProjectionTypes &projectionType,
                                                                const Eigen::MatrixXd &points) const
    {
    ...
    inline Eigen::MatrixXd ComputePolynomialsLaplacianValues(const Polydim::VEM::PCC::VEM_PCC_3D_ReferenceElement_Data &reference_element_data,
                                                             const Polydim::VEM::PCC::VEM_PCC_3D_LocalSpace_Data &localSpace,
                                                             const Eigen::MatrixXd &points) const
    {
