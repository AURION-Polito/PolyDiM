    ...
    VEM_PCC_3D_LocalSpace_Data &localSpace) const
{
    ...
    if (localSpace.Order == 1)
    {
        ...
        localSpace.Bmatrix.row(0) = boundaryQuadratureWeights.transpose() * localSpace.VanderFaceProjections;
    ...
    else
    {
        ...
        // Bmatrix(0, localSpace.NumVertexBasisFunctions + localSpace.NumEdgeBasisFunctions) = measure *
        // Qmatrix.inverse().topRows(1).sum();
        localSpace.Bmatrix.row(0) << MatrixXd::Zero(1, localSpace.NumBoundaryBasisFunctions),
