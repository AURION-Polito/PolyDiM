                                                                   ...
                                                                   VEM_PCC_2D_LocalSpace_Data &localSpace) const
{
    ...
    localSpace.Ematrix[0] = localSpace.Qmatrix.topLeftCorner(localSpace.Nkm1, localSpace.Nkm1)
                            * localSpace.Ematrix[0];
    localSpace.Ematrix[1] = localSpace.Qmatrix.topLeftCorner(localSpace.Nkm1, localSpace.Nkm1)
