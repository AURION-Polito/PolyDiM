...
struct VEM_PCC_2D_LocalSpace_Data final
{
    ...
    unsigned int NumVertexBasisFunctions; ///< Number of basis functions corresponding to degrees of freedom on vertices.
    unsigned int NumEdgeBasisFunctions; ///< Number of basis functions corresponding to degrees of freedom internal to edges.
    unsigned int NumBoundaryBasisFunctions; ///< Sum of \ref VEM::PCC::VEM_PCC_2D_LocalSpace_Data::NumVertexBasisFunctions and \ref VEM::PCC::VEM_PCC_2D_LocalSpace_Data::NumEdgeBasisFunctions.
