...
unsigned int Polydim::examples::SUPG_PCC_2D::test::Patch_Test::order;

int main(int argc, char **argv)
{
    Polydim::examples::SUPG_PCC_2D::Program_configuration config;
    ...
    Polydim::examples::SUPG_PCC_2D::test::Patch_Test::order = config.VemOrder();

    const auto test = Polydim::examples::SUPG_PCC_2D::program_utilities::create_test(config);
    ...
    Polydim::examples::SUPG_PCC_2D::program_utilities::create_domain_mesh(config, domain, mesh);
    ...
    const auto meshGeometricData =
        Polydim::examples::SUPG_PCC_2D::program_utilities::create_domain_mesh_geometric_properties(config, mesh);
    ...
    Polydim::examples::SUPG_PCC_2D::Assembler assembler;
    auto assembler_data =
    ...
    Polydim::examples::SUPG_PCC_2D::program_utilities::export_solution(config, mesh, dofs_data, assembler_data, post_process_data, exportSolutionFolder, exportVtuFolder);

    Polydim::examples::SUPG_PCC_2D::program_utilities::export_dofs(config,
                                                                   mesh,
                                                                   meshGeometricData,
                                                                   meshDOFsInfo,
