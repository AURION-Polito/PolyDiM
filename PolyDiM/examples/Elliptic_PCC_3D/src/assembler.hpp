    ...
    namespace Elliptic_PCC_2D
    {
      namespace Assembler
      {
        ...
        void ComputeStrongTerm(const Gedim::MeshMatricesDAO& mesh,
                               ...
                               Elliptic_PCC_2D_Problem_Data& assembler_data)
        {
        ...
        template <typename vem_local_space_type>
        ...
        PostProcess_Data PostProcessSolution(const Gedim::MeshMatricesDAO& mesh,
                                             ...
                                             const std::function<std::array<Eigen::VectorXd, 3>(const Eigen::MatrixXd&)>& exact_derivative_solution)
        {
