                     ...
                     const std::string& exportVtuFolder)
{
    ...
    {       
        ...
        std::cout << scientific << dofs_data[0].NumberDOFs + dofs_data[1].NumberDOFs
                                       + dofs_data[2].NumberDOFs + dofs_data[3].NumberDOFs << separator;
        std::cout << scientific << dofs_data[0].NumberStrongs + dofs_data[1].NumberStrongs
                                       + dofs_data[2].NumberStrongs + dofs_data[3].NumberStrongs << separator;
    ...
    {    
        ...
        errorFile << scientific << dofs_data[0].NumberDOFs + dofs_data[1].NumberDOFs
                                       + dofs_data[2].NumberDOFs + dofs_data[3].NumberDOFs << separator;
        errorFile << scientific << dofs_data[0].NumberStrongs + dofs_data[1].NumberStrongs
                                       + dofs_data[2].NumberStrongs + dofs_data[3].NumberStrongs << separator;
