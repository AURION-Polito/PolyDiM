...
#include "VEM_DF_PCC_3D_Velocity_LocalSpace_Creator.hpp"
    ...
    const Polydim::examples::Stokes_DF_PCC_3D::test::I_Test &test) const
{
    ...
    {
        const Polydim::VEM::DF_PCC::VEM_DF_PCC_3D_Polygon_Geometry polygon = {config.GeometricTolerance1D(),
        ...
        const auto vem_local_space = Polydim::VEM::DF_PCC::create_VEM_DF_PCC_3D_local_space(config.VemType());
