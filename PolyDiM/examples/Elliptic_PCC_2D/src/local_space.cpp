      ...
      namespace local_space
      {
                                                     ...
                                                     const unsigned int method_order)
        {
          ...
          switch (reference_element_data.Method_Type)
          {
            ...
            case Program_configuration::MethodTypes::VEM_PCC_Ortho:
            {
              ...
              reference_element_data.VEM_ReferenceElement = Polydim::VEM::PCC::create_VEM_PCC_2D_reference_element(reference_element_data.VEM_Type);
                                         ...
                                         const ReferenceElement_Data& reference_element_data)
        {
          ...
          switch (reference_element_data.Method_Type)
          {
            case Program_configuration::MethodTypes::FEM_Triangle_PCC:
            {
              ...
              local_space_data.FEM_LocalSpace_Data = reference_element_data.FEM_LocalSpace->CreateLocalSpace(reference_element_data.FEM_ReferenceElement_Data,
                                                                                                             local_space_data.FEM_Geometry);
            }
            case Program_configuration::MethodTypes::VEM_PCC:
            case Program_configuration::MethodTypes::VEM_PCC_Inertia:
            case Program_configuration::MethodTypes::VEM_PCC_Ortho:
            {
              ...
              local_space_data.VEM_LocalSpace_Data = reference_element_data.VEM_LocalSpace->CreateLocalSpace(reference_element_data.VEM_ReferenceElement_Data,
                                             ...
                                             const LocalSpace_Data& local_space_data)
        {
          switch (reference_element_data.Method_Type)
          {
            ...
            case Program_configuration::MethodTypes::VEM_PCC_Ortho:
            {
              return reference_element_data.VEM_LocalSpace->ComputeBasisFunctionsValues(local_space_data.VEM_LocalSpace_Data,
                                            ...
                                            const unsigned int edge_local_index)
        {
          switch (reference_element_data.Method_Type)
          {
            case Program_configuration::MethodTypes::FEM_Triangle_PCC:
            {
              ...
              const Eigen::MatrixXd edge_dofs_coordinates = dof_coordinates.block(0,
                                                                                  cell1DStartingLocalIdex,
                                                                                  3,
                                                                                  num_edge_dofs);
            ...
            case Program_configuration::MethodTypes::VEM_PCC_Ortho:
            {
              ...
              {
                edge_dofs_coordinates.col(r) << edge_origin +
                                                edge_direction *
                                                referenceEdgeDOFsPoint(0, r) *
                                                edge_tangent;
              }
        ...
        std::array<unsigned int, 4> ReferenceElementNumDOFs(const ReferenceElement_Data& reference_element_data)
        {
          switch (reference_element_data.Method_Type)
          {
            ...
            {
              return {
                reference_element_data.FEM_ReferenceElement_Data.NumDofs0D,
            ...
            {
              return {
                reference_element_data.VEM_ReferenceElement_Data.NumDofs0D,
                                            ...
                                            const LocalSpace_Data& local_space_data)
        {
          ...
          switch (reference_element_data.Method_Type)
          {
            case Program_configuration::MethodTypes::FEM_Triangle_PCC:
            {
              performance.VEM_Performance_Data.NumInternalQuadraturePoints = local_space_data.FEM_LocalSpace_Data.InternalQuadrature.Weights.size();
            }
              break;
            case Program_configuration::MethodTypes::VEM_PCC:
            case Program_configuration::MethodTypes::VEM_PCC_Inertia:
            case Program_configuration::MethodTypes::VEM_PCC_Ortho:
            {
              ...
              performance.VEM_Performance_Data.Analysis = performanceAnalysis.Compute(Polydim::VEM::Monomials::VEM_Monomials_2D(),
              ...
              performance.VEM_Performance_Data.NumInternalQuadraturePoints = local_space_data.VEM_LocalSpace_Data.InternalQuadrature.Weights.size();
              performance.VEM_Performance_Data.NumBoundaryQuadraturePoints = local_space_data.VEM_LocalSpace_Data.BoundaryQuadrature.Quadrature.Weights.size();
            }
            default:
              throw std::runtime_error("method type " + std::to_string((unsigned int)reference_element_data.Method_Type) + " not supported");
          }
