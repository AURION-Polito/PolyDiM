...
int main(int argc, char** argv)
{
  ...
  auto post_process_data = Polydim::examples::Elliptic_PCC_2D::Assembler::PostProcessSolution(mesh,
                                                                                              meshGeometricData,
                                                                                              dofs_data,
                                                                                              reference_element_data,
                                                                                              vem_local_space,
  ...
  {
    const auto vemPerformance = Polydim::examples::Elliptic_PCC_2D::Assembler::ComputeVemPerformance(mesh,
                                                                                                     meshGeometricData,
                                                                                                     reference_element_data,
                                                                                                     vem_local_space);
    {
