...
int main(int argc, char **argv)
{
    ...
    Polydim::examples::Elliptic_PCC_2D::program_utilities::export_solution(config, mesh, dofs_data, assembler_data, post_process_data, exportCsvFolder, exportVtuFolder);
    ...
    if (config.ComputeMethodPerformance())
    {
        ...
        Polydim::examples::Elliptic_PCC_2D::program_utilities::export_performance(config, performance, exportCsvFolder);
