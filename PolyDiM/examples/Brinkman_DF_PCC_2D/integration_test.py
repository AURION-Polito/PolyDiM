...
def test_errors(errors,
    ...
    if (num_rows == 2):
        ...
        if test_type == 3:
            ...
            if vem_order >= 4:
                print("CASE ", str(test_type), " : [", abs(errors[0, 1]), " , ", abs(errors[1, 1]), " ], ",
                ...
                print("CASE ", str(test_type), " : [", abs(errors[0, 1]), " , " , abs(errors[1, 1]), " ], ", slope_L2_pres)
            ...
            print("CASE " + str(test_type) + " : ", slope_H1_vel, slope_L2_pres)
            assert round(slope_L2_pres) == round(float(vem_order))
        ...
        raise Exception("Num rows = {0} not managed".format(num_rows))
