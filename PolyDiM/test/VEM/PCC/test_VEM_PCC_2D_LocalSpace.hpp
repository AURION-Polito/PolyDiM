...
TEST(Test_VEM_PCC, Test_VEM_PCC_2D_O1)
{
    ...
    ASSERT_TRUE(
        geometry_utilities.IsValueGreaterOrEqual(1.5e-14, result.ErrorStabilization, geometry_utilities.Tolerance1D()));
}
...
TEST(Test_VEM_PCC, Test_VEM_PCC_2D_O3)
{
    ...
    for (unsigned int d = 0; d < 2; ++d)
        ASSERT_TRUE(geometry_utilities.IsValueGreaterOrEqual(
            1.0e-13, result.ErrorPi0km1Grad[d], geometry_utilities.Tolerance1D()));
    ASSERT_TRUE(
        geometry_utilities.IsValueGreaterOrEqual(1.0e-13, result.ErrorStabilization, geometry_utilities.Tolerance1D()));
}
} // namespace UnitTesting
} // namespace Polydim
