...
Test_VEM_MCC_3D_Polyhedron_Geometry Test_VEM_MCC_3D_Geometry(const Gedim::GeometryUtilities& geometry_utilities)
{
    ...
    {
        const Eigen::MatrixXd facesVertices2D = geometry_utilities.RotatePointsFrom3DTo2D(facesVertices[f],
        ...
        result.FacesTriangulationVertices2D[f] = geometry_utilities.ExtractTriangulationPoints(facesVertices2D,
                                                                                               facesTriangulation);
        ...
        result.FacesCentroid2D[f] = geometry_utilities.PolygonCentroid(facesVertices2D,
                                                                       result.FacesMeasure[f]);

    }

    std::vector<std::vector<unsigned int>> facesTriangulation3D = geometry_utilities.PolyhedronFaceTriangulationsByFirstVertex(cube.Faces,
                                                                                                                               facesVertices);
...
TEST(Test_VEM_MCC, Test_VEM_MCC_3D_O0_O1_O2_O3)
{
    ...
    Polydim::VEM::MCC::VEM_MCC_3D_Polyhedron_Geometry polyhedron =
        {
            geometry_utilities,
