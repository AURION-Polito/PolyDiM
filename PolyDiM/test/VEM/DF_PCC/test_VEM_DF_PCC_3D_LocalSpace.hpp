...
//#include "VEM_DF_PCC_3D_LocalSpace.hpp"
...
//{
//struct Test_VEM_DF_PCC_2D_PolygonalFaces_Geometry final
//{
...
//{
//    std::vector<Test_VEM_DF_PCC_2D_PolygonalFaces_Geometry> PolygonalFaces;
...
//    Gedim::GeometryUtilities::Polyhedron cube = geometry_utilities.CreateParallelepipedWithOrigin(origin,
//                                                                                                  length,
//                                                                                                  height,
//                                                                                                  width);
...
//    result.EdgesTangent = geometry_utilities.PolyhedronEdgeTangents(result.Vertices,
//                                                                    result.Edges);
//    result.EdgesDirection.resize(12, true);

//    const std::vector<Eigen::MatrixXd> facesVertices = geometry_utilities.PolyhedronFaceVertices(result.Vertices,
//                                                                                                 result.Faces);
...
//    result.FacesRotationMatrix = geometry_utilities.PolyhedronFaceRotationMatrices(facesVertices,
//                                                                                   result.FacesNormals,
...
//    std::vector<std::vector<bool>> facesEdgeDirections = geometry_utilities.PolyhedronFaceEdgeDirections(result.Vertices,
//                                                                                                         result.Edges,
//                                                                                                         result.Faces);
...
//        std::vector<unsigned int> facesTriangulation = geometry_utilities.PolygonTriangulationByFirstVertex(result.PolygonalFaces[f].Vertices);
//        result.PolygonalFaces[f].TriangulationVertices = geometry_utilities.ExtractTriangulationPoints(result.PolygonalFaces[f].Vertices,
//                                                                                                       facesTriangulation);
...
//        result.PolygonalFaces[f].Centroid = geometry_utilities.PolygonCentroid(result.PolygonalFaces[f].Vertices,
//                                                                               result.PolygonalFaces[f].Measure);
...
//    std::vector<std::vector<unsigned int>> facesTriangulation3D = geometry_utilities.PolyhedronFaceTriangulationsByFirstVertex(result.Faces,
//                                                                                                                               facesVertices);

//    std::vector<unsigned int> polyhedronTetrahedrons = geometry_utilities.PolyhedronTetrahedronsByFaceTriangulations(result.Vertices,
//                                                                                                                     result.Faces,
//                                                                                                                     facesTriangulation3D,
//                                                                                                                     result.Centroid);

//    result.TetrahedronVertices = geometry_utilities.ExtractTetrahedronPoints(result.Vertices,
//                                                                             result.Centroid,
...
////    std::vector<Polydim::VEM::DF_PCC::VEM_DF_PCC_2D_Polygon_Geometry> polygonalFaces;
...
////    {
////        Polydim::VEM::DF_PCC::VEM_DF_PCC_2D_ReferenceElement vem_reference_element_2D;
////        Polydim::VEM::DF_PCC::VEM_DF_PCC_3D_ReferenceElement vem_reference_element_3D;
////        Polydim::VEM::DF_PCC::VEM_DF_PCC_3D_LocalSpace vem_local_space;
...
////        const auto refPiNabla = Test_VEM_DF_PCC_3D_RefPiNabla()[k-1];
...
////        ASSERT_TRUE(geometry_utilities.IsValueGreaterOrEqual(9.0e-14,
////                                                             result.ErrorPiNabla,
////                                                             geometry_utilities.Tolerance1D()));
////        ASSERT_TRUE(geometry_utilities.IsValueGreaterOrEqual(7.4e-14,
////                                                             result.ErrorPi0km1,
////                                                             geometry_utilities.Tolerance1D()));
////        ASSERT_TRUE(geometry_utilities.IsValueGreaterOrEqual(3.5e-13,
////                                                             result.ErrorPi0k,
////                                                             geometry_utilities.Tolerance1D()));
////        ASSERT_EQ(result.ErrorPi0km1Grad.size(), 3);
////        for(unsigned int d = 0; d < 3; ++d)
////            ASSERT_TRUE(geometry_utilities.IsValueGreaterOrEqual(8e-13,
////                                                                 result.ErrorPi0km1Grad[d],
////                                                                 geometry_utilities.Tolerance1D()));
////        ASSERT_TRUE(geometry_utilities.IsValueGreaterOrEqual(6.5e-12,
