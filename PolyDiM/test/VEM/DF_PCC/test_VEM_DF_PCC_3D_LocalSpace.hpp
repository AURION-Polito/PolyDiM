...
Test_VEM_DF_PCC_3D_Polyhedron_Geometry Test_VEM_DF_PCC_3D_Geometry(const Gedim::GeometryUtilities& geometry_utilities)
{
    ...
    result.FacesTangents = geometry_utilities.PolyhedronFaceTangents(facesVertices,
                                                                     result.FacesNormals,
    ...
    for (unsigned int f = 0; f < numFaces; ++f)
    {
        result.FacesTangentsGlobalDirection[f][0] =
            facesEdgeDirections[f][0];
        result.FacesTangentsGlobalDirection[f][1] =
            result.FacesTangentsGlobalDirection[f][0] ==
            result.FacesNormalGlobalDirection[f];
    }
