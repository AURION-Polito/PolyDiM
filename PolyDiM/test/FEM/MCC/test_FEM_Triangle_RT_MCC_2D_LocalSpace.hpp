...
TEST(Test_FEM_Triangle_RT_MCC_2D, Test_FEM_Triangle_RT_MCC_2D_Local_Space)
{
    ...
    for (unsigned int o = 0; o < 5; o++)
    {
        ...
        // const auto basisValues = local_space.ComputeBasisFunctionsValues(reference_element_data, local_space_data,
        // points); const auto gradBasisValues =
        ...
        // }
        // ASSERT_TRUE((internal_integral - boundary_integral).norm() < 1.0e-14 * std::max(1.0,
